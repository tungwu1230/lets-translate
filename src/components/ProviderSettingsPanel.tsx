      ...
      <div className="drawer-body">
        ...
        <div className="settings-group">
          ...
          <div className="security-note">
            ...
            <span>API key 只會儲存在此瀏覽器中：{maskApiKey(activeKey) || '尚未輸入'}</span>
          </div>
        </div>
          ...
          <div className="settings-group">
            ...
            <div className="model-strip" aria-label="模型資訊">
              {activeModels.map((model) => (
                <span
                  key={model.id}
                  className={`model-pill ${activeModelId === model.id ? 'active-pill' : ''}`}
                  title={model.notes}
                >
                  {model.label}
                </span>
          ...
          <div className="config-grid">
            <div className="config-item">
              ...
              <select
                value={settings.mode}
                onChange={(event) =>
                  onChange({ ...settings, mode: event.target.value as TranslationMode })
                }
              >
            ...
            <div className="config-item">
              ...
              <select
                value={settings.tone}
                onChange={(event) =>
                  onChange({ ...settings, tone: event.target.value as TranslationTone })
                }
              >
